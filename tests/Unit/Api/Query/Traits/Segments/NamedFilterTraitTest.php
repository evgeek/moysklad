...
/** @covers \Evgeek\Moysklad\Api\Query\Traits\Segments\NamedFilterTrait */
class NamedFilterTraitTest extends TraitTestCase
{
    public function testReturnsCorrectClass(): void
    {
        ...
        $this->assertInstanceOf(NamedFilterSegment::class, $builder);
