...
/** @covers \Evgeek\Moysklad\Api\Query\Traits\Segments\ById\ByIdVariantTrait */
class ByIdVariantTraitTest extends TraitTestCase
{
    public function testReturnsCorrectClass(): void
    {
        ...
        $this->assertInstanceOf(ByIdVariantSegment::class, $builder);
