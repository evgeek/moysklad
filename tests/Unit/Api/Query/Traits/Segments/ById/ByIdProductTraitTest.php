...
/** @covers \Evgeek\Moysklad\Api\Query\Traits\Segments\ById\ByIdProductTrait */
class ByIdProductTraitTest extends TraitTestCase
{
    public function testReturnsCorrectClass(): void
    {
        ...
        $this->assertInstanceOf(ByIdProductSegment::class, $builder);
