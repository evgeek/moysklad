...
- В метод `filter()` можно передавать несколько фильтров за раз при помощи массива массивов. Примеры есть в [README](/##параметры-запроса) и PHPDoc метода.
- В метод `order()` также можно передавать несколько сортировок за раз при помощи массива массивов.
