...
trait ByIdWithPositionsTrait
{
     ...
     * </code>
     */
    public function byId(string $guid): ByIdWithPositionsSegment
    {
        return $this->resolveCommonBuilder(ByIdWithPositionsSegment::class, $guid);
    }
}
